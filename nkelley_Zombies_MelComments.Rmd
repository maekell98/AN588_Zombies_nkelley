...
```{r install packages/data, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
*It is nice to split up your installation and library-ing into different chunks so we don't have to do it all everytime*
...
*great use of cbind()- very clean results!* 
...
*You don't need to read in the data everytime- "d" is already saved in your environment*
...
*adding a line would help show this! (use geom_smooth)*
...
*Nice way of using ggplot to do this! You can also just use hist() and qqnorm as we have been*
...
*If you think it is a poisson, then you can also use qpois() similarly to qnorm()*
...
3. I had a lot of trouble figuring out how to use bootstrapping functions. I feel like this stemmed from a desire to use a function with "bootstrap" in the name that would just spit the answers out, which resulted in lots of difficulty with syntax and understanding what I was doing. When I just broke it down to the for loop, I had a much better idea of what bootstrapping even was. Obviously, this was in the modules, but I didn't really understand it until I was doing it for the homework. *there is also a boot() function, but what you did worked great*
