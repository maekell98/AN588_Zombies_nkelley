...
#the above population functions courtesy of Miguel. I believe he calculated sd better than I did, so I inserted his function for sd into my cbind function below.
...
n <- 30
for (i in 1:10000) {
    zkset[i] <- mean(sample(a$zombies_killed, n, replace = FALSE))
}
...
poisson.test(d$years_of_education, conf.level = 0.95 )
